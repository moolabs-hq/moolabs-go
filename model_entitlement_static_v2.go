...
// checks if the EntitlementStaticV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EntitlementStaticV2{}
...
type _EntitlementStaticV2 EntitlementStaticV2
...
func (o EntitlementStaticV2) MarshalJSON() ([]byte, error) {
...
func (o EntitlementStaticV2) ToMap() (map[string]interface{}, error) {
...
func (o *EntitlementStaticV2) UnmarshalJSON(data []byte) (err error) {
	...
	varEntitlementStaticV2 := _EntitlementStaticV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEntitlementStaticV2)

	if err != nil {
		return err
	}

	*o = EntitlementStaticV2(varEntitlementStaticV2)

	return err
}

type NullableEntitlementStaticV2 struct {
	value *EntitlementStaticV2
	isSet bool
}

func (v NullableEntitlementStaticV2) Get() *EntitlementStaticV2 {
	return v.value
}

func (v *NullableEntitlementStaticV2) Set(val *EntitlementStaticV2) {
	v.value = val
	v.isSet = true
}

func (v NullableEntitlementStaticV2) IsSet() bool {
	return v.isSet
}

func (v *NullableEntitlementStaticV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEntitlementStaticV2(val *EntitlementStaticV2) *NullableEntitlementStaticV2 {
	return &NullableEntitlementStaticV2{value: val, isSet: true}
}

func (v NullableEntitlementStaticV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEntitlementStaticV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
