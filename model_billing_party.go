...
// checks if the BillingParty type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &BillingParty{}
...
func (o BillingParty) MarshalJSON() ([]byte, error) {
...
func (o BillingParty) ToMap() (map[string]interface{}, error) {
...
type NullableBillingParty struct {
	value *BillingParty
	isSet bool
}

func (v NullableBillingParty) Get() *BillingParty {
	return v.value
}

func (v *NullableBillingParty) Set(val *BillingParty) {
	v.value = val
	v.isSet = true
}

func (v NullableBillingParty) IsSet() bool {
	return v.isSet
}

func (v *NullableBillingParty) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBillingParty(val *BillingParty) *NullableBillingParty {
	return &NullableBillingParty{value: val, isSet: true}
}

func (v NullableBillingParty) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBillingParty) UnmarshalJSON(src []byte) error {
	v.isSet = true
