...
type CreateSnapshotRequest struct {
	...
	AsOfRecordedAt NullableTime `json:"as_of_recorded_at,omitempty"`
...
// GetAsOfRecordedAt returns the AsOfRecordedAt field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CreateSnapshotRequest) GetAsOfRecordedAt() time.Time {
	if o == nil || IsNil(o.AsOfRecordedAt.Get()) {
		var ret time.Time
		return ret
	}
	return *o.AsOfRecordedAt.Get()
}
...
// SetAsOfRecordedAt gets a reference to the given NullableTime and assigns it to the AsOfRecordedAt field.
func (o *CreateSnapshotRequest) SetAsOfRecordedAt(v time.Time) {
	o.AsOfRecordedAt.Set(&v)
}
// SetAsOfRecordedAtNil sets the value for AsOfRecordedAt to be an explicit nil
func (o *CreateSnapshotRequest) SetAsOfRecordedAtNil() {
	o.AsOfRecordedAt.Set(nil)
}
...
func (o CreateSnapshotRequest) ToMap() (map[string]interface{}, error) {
	...
	if o.AsOfRecordedAt.IsSet() {
		toSerialize["as_of_recorded_at"] = o.AsOfRecordedAt.Get()
	}
