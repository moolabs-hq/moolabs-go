...
type QuoteRedlineResponse struct {
	...
	ClauseFamily *string `json:"clause_family,omitempty"`
	Verdict *string `json:"verdict,omitempty"`
	MatchedTier *string `json:"matched_tier,omitempty"`
	CitedSpan map[string]interface{} `json:"cited_span,omitempty"`
...
// GetClauseFamily returns the ClauseFamily field value if set, zero value otherwise.
func (o *QuoteRedlineResponse) GetClauseFamily() string {
	if o == nil || IsNil(o.ClauseFamily) {
		var ret string
		return ret
	}
	return *o.ClauseFamily
}

// GetClauseFamilyOk returns a tuple with the ClauseFamily field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QuoteRedlineResponse) GetClauseFamilyOk() (*string, bool) {
	if o == nil || IsNil(o.ClauseFamily) {
		return nil, false
	}
	return o.ClauseFamily, true
}
...
// SetClauseFamily gets a reference to the given string and assigns it to the ClauseFamily field.
...
// GetCitedSpan returns the CitedSpan field value if set, zero value otherwise.
func (o *QuoteRedlineResponse) GetCitedSpan() map[string]interface{} {
	if o == nil || IsNil(o.CitedSpan) {
		var ret map[string]interface{}
		return ret
	}
	return o.CitedSpan
...
// GetCitedSpanOk returns a tuple with the CitedSpan field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *QuoteRedlineResponse) GetCitedSpanOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.CitedSpan) {
		return map[string]interface{}{}, false
	}
	return o.CitedSpan, true
}
...
// SetCitedSpan gets a reference to the given map[string]interface{} and assigns it to the CitedSpan field.
...
func (o QuoteRedlineResponse) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ClauseFamily) {
		toSerialize["clause_family"] = o.ClauseFamily
	}
	if !IsNil(o.Verdict) {
	...
	if !IsNil(o.CitedSpan) {
		toSerialize["cited_span"] = o.CitedSpan
	}
