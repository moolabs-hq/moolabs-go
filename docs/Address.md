...
------------ | ------------- | ------------- | -------------
**Country** | Pointer to **string** | Country code in [ISO 3166-1](https://www.iso.org/iso-3166-country-codes.html) alpha-2 format. | [optional] 
**PostalCode** | Pointer to **string** | Postal code. | [optional] 
**State** | Pointer to **string** | State or province. | [optional] 
