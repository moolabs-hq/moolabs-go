...
`func (o *CustomSubscriptionChange) GetQuoteOriginKey() string`

GetQuoteOriginKey returns the QuoteOriginKey field if non-nil, zero value otherwise.

### GetQuoteOriginKeyOk

`func (o *CustomSubscriptionChange) GetQuoteOriginKeyOk() (*string, bool)`
...
`func (o *CustomSubscriptionChange) SetQuoteOriginKey(v string)`

SetQuoteOriginKey sets QuoteOriginKey field to given value.

### HasQuoteOriginKey

`func (o *CustomSubscriptionChange) HasQuoteOriginKey() bool`
