...
type BuyerQuoteProjection struct {
	...
	SellerBranding map[string]interface{} `json:"seller_branding,omitempty"`
	TermsAndConditions *string `json:"terms_and_conditions,omitempty"`
	BuyerRequestStatus *string `json:"buyer_request_status,omitempty"`
}
...
func NewBuyerQuoteProjection(quoteId string, version int32, status string, buyerContact map[string]interface{}, lineItems []BuyerQuoteLineItem, commercialTerms map[string]interface{}, creditTerms map[string]interface{}, pricing BuyerQuotePricing) *BuyerQuoteProjection {
	...
	var buyerRequestStatus string = "none"
...
// GetSellerBranding returns the SellerBranding field value if set, zero value otherwise.
func (o *BuyerQuoteProjection) GetSellerBranding() map[string]interface{} {
	if o == nil || IsNil(o.SellerBranding) {
		var ret map[string]interface{}
		return ret
	}
	return o.SellerBranding
}

// GetSellerBrandingOk returns a tuple with the SellerBranding field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BuyerQuoteProjection) GetSellerBrandingOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.SellerBranding) {
		return map[string]interface{}{}, false
	}
	return o.SellerBranding, true
}
...
// SetSellerBranding gets a reference to the given map[string]interface{} and assigns it to the SellerBranding field.
...
// GetBuyerRequestStatus returns the BuyerRequestStatus field value if set, zero value otherwise.
func (o *BuyerQuoteProjection) GetBuyerRequestStatus() string {
	if o == nil || IsNil(o.BuyerRequestStatus) {
		var ret string
		return ret
	}
	return *o.BuyerRequestStatus
}

// GetBuyerRequestStatusOk returns a tuple with the BuyerRequestStatus field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *BuyerQuoteProjection) GetBuyerRequestStatusOk() (*string, bool) {
	if o == nil || IsNil(o.BuyerRequestStatus) {
		return nil, false
	}
	return o.BuyerRequestStatus, true
}
...
// SetBuyerRequestStatus gets a reference to the given string and assigns it to the BuyerRequestStatus field.
func (o *BuyerQuoteProjection) SetBuyerRequestStatus(v string) {
	o.BuyerRequestStatus = &v
}
...
func (o BuyerQuoteProjection) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SellerBranding) {
		toSerialize["seller_branding"] = o.SellerBranding
	}
	if !IsNil(o.TermsAndConditions) {
		toSerialize["terms_and_conditions"] = o.TermsAndConditions
	}
	if !IsNil(o.BuyerRequestStatus) {
		toSerialize["buyer_request_status"] = o.BuyerRequestStatus
	}
