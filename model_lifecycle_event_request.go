...
// GetSubscriptionData returns the SubscriptionData field value if set, zero value otherwise.
...
// GetPayloadJson returns the PayloadJson field value if set, zero value otherwise.
func (o *LifecycleEventRequest) GetPayloadJson() string {
	if o == nil || IsNil(o.PayloadJson) {
		var ret string
		return ret
	}
...
// SetPayloadJson gets a reference to the given string and assigns it to the PayloadJson field.
...
func (o LifecycleEventRequest) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SubscriptionData) {
		toSerialize["subscription_data"] = o.SubscriptionData
	}
	if !IsNil(o.PayloadJson) {
		toSerialize["payload_json"] = o.PayloadJson
	}
