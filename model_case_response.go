...
// checks if the CaseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CaseResponse{}

// CaseResponse GET /cases/{id} response.
...
type _CaseResponse CaseResponse
...
func (o CaseResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CaseResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCaseResponse := _CaseResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCaseResponse)

	if err != nil {
		return err
	}

	*o = CaseResponse(varCaseResponse)

	return err
}

type NullableCaseResponse struct {
	value *CaseResponse
	isSet bool
}

func (v NullableCaseResponse) Get() *CaseResponse {
	return v.value
}

func (v *NullableCaseResponse) Set(val *CaseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCaseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCaseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCaseResponse(val *CaseResponse) *NullableCaseResponse {
	return &NullableCaseResponse{value: val, isSet: true}
}

func (v NullableCaseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCaseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
