...
// checks if the SubscriptionPhase type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SubscriptionPhase{}
...
type _SubscriptionPhase SubscriptionPhase
...
func (o SubscriptionPhase) MarshalJSON() ([]byte, error) {
...
func (o SubscriptionPhase) ToMap() (map[string]interface{}, error) {
...
func (o *SubscriptionPhase) UnmarshalJSON(data []byte) (err error) {
	...
	varSubscriptionPhase := _SubscriptionPhase{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubscriptionPhase)

	if err != nil {
		return err
	}

	*o = SubscriptionPhase(varSubscriptionPhase)

	return err
}

type NullableSubscriptionPhase struct {
	value *SubscriptionPhase
	isSet bool
}

func (v NullableSubscriptionPhase) Get() *SubscriptionPhase {
	return v.value
}

func (v *NullableSubscriptionPhase) Set(val *SubscriptionPhase) {
	v.value = val
	v.isSet = true
}

func (v NullableSubscriptionPhase) IsSet() bool {
	return v.isSet
}

func (v *NullableSubscriptionPhase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSubscriptionPhase(val *SubscriptionPhase) *NullableSubscriptionPhase {
	return &NullableSubscriptionPhase{value: val, isSet: true}
}

func (v NullableSubscriptionPhase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSubscriptionPhase) UnmarshalJSON(src []byte) error {
	v.isSet = true
